...
SECRET_KEY = 'django-insecure-_d_ijzway9$^#b$vt&tivyef0-2p#%7ck*)b8h+((1l+)e_lw$'
...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","http://leonita-cecilia-mentalhealthtracker.pbp.cs.ui.ac.id", "https://leonita-cecilia-mentalhealthtracker.pbp.cs.ui.ac.id"]
